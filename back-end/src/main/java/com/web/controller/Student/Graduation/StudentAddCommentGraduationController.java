...
@RestController
@RequestMapping("/api/graduation/student/comment")
public class StudentAddCommentGraduationController {
    private static final Logger logger = LoggerFactory.getLogger(StudentAddCommentGraduationController.class);
    @Autowired
    ...
    @Autowired
    public StudentAddCommentGraduationController(TokenUtils tokenUtils){
