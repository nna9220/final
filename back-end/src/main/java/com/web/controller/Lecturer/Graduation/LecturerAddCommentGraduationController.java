...
@RestController
@RequestMapping("/api/lecturer/graduation/comment")
public class LecturerAddCommentGraduationController {
    ...
    @Autowired
    public LecturerAddCommentGraduationController(TokenUtils tokenUtils){
