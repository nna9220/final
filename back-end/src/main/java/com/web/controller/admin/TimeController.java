...
public class TimeController {
    ...
    public ResponseEntity<?> createAllTime(
        ...
        TypeSubject typeSubject = typeSubjectRepository.findSubjectByName("Tiểu luận chuyên ngành");
        ResponseEntity<?> response = timeService.createAllTime(
                registrationTimeStart, registrationTimeEnd, registrationName, typeSubject,
                timeBrowsOfHeadStart, timeBrowsOfHeadEnd,
                registrationPeriodStart, registrationPeriodEnd, registrationPeriodName,
                reportSubmissionTimeStart, reportSubmissionTimeEnd, reportSubmissionTimeName,
                councilReportTimeStart, councilReportTimeEnd, councilReportTimeName
        );
        // Xử lý file Excel
