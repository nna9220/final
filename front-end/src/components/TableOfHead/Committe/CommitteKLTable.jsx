...
function CommitteKLTable() {
  ...
  // Function to call the criteria API and pass the outputPath
  const exportCriteriaFile = () => {
    axiosInstance.get('/graduation/export/criteria', {
      params: { outputPath },
      headers: {
        'Authorization': `Bearer ${userToken}`
      }
  ...
  return (
    <div style={{ margin: '20px' }}>
      ...
      <div>
        ...
        />
        <button onClick={exportCriteriaFile}>Export</button>
      </div>
    </div>
  );
}
