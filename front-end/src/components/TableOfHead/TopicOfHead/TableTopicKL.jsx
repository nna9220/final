...
export default function TableTopicKL() {
    ...
    const handleSubmit100 = () => {
        ...
        if (subjectIdForSubmit100) {
            axiosInstance.post(`/head/manageTutorial/graduation/OneHundredRecent/${subjectIdForSubmit100}`, {}, {
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                }
            })
    ...
    const handleSubmitApproval = () => {
        ...
        if (subjectIdForApproval) {
            axiosInstance.post(`/head/manageTutorial/graduation/browse/${subjectIdForApproval}`, {}, {
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                }
            })
                                            ...
                                            <div style={{ display: 'flex' }}>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#modalApproval" data-bs-placement="bottom" onClick={() => { setSubjectIdForApproval(item.subjectId); setSubjectName(item.subjectName) }}>Nhận xét, đánh giá</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </td>
