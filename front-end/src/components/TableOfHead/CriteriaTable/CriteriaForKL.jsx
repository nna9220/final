...
function CriteriaForKL() {
    ...
    const fetchCriterias = () => {
        ...
        if (userToken) {
            axiosInstance.get('/head/graduation/criteria/list', {
                headers: {
    ...
    const handleSubmitAdd = () => {
        ...
        axiosInstance.post('/head/graduation/criteria/create', null, {
            params: {
    ...
    const handleSubmitEdit = () => {
        ...
        axiosInstance.post(`/head/graduation/criteria/edit/${editCriteriaId}`, null, {
            params: {
    ...
    const handleSubmitDelete = () => {
        axiosInstance.post(`/head/graduation/criteria/delete/${deleteCriteriaId}`, null, {
            headers: {
                'Authorization': `Bearer ${userToken}`,
            }
        })
