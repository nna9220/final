...
function DataTableTimeRegister() {
    ...
    useEffect(() => {
        ...
        if (tokenSt) {
            ...
            axiosInstance.get('/admin/timeAddSubject', {
                headers: {
    ...
    const handleEditTimeApprove = () => {
        ...
        if (tokenSt && selectedTimeId) {
            axiosInstance.post(`/admin/timeAddSubject/edit/${selectedTimeId}`, {
    ...
    const handleAddType = () => {
        ...
        if (tokenSt) {
            axiosInstance.post('/admin/timeAddSubject/create', formattedNewTimeApprove, {
                headers: {
                    'Authorization': `Bearer ${tokenSt}`,
                    'Content-Type': 'multipart/form-data',
                },
...
export default DataTableTimeRegister