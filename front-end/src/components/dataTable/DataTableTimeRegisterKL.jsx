...
function DataTableTimeRegisterKL() {
    ...
    useEffect(() => {
        ...
        if (tokenSt) {
            ...
            axiosInstance.get('/admin/graduation/timeAddSubject', {
                headers: {
    ...
    const handleEditTimeApprove = () => {
        ...
        if (tokenSt && selectedTimeId) {
            axiosInstance.post(`/admin/graduation/timeAddSubject/edit/${selectedTimeId}`, {
    ...
    const handleAddType = () => {
        ...
        if (tokenSt) {
            axiosInstance.post('/admin/graduation/timeAddSubject/create', formattedNewTimeApprove, {
                headers: {
                    'Authorization': `Bearer ${tokenSt}`,
                    'Content-Type': 'multipart/form-data',
                },
...
export default DataTableTimeRegisterKL