...
export default function TopicTable() {
    ...
    const handleSubmitApproval = () => {
        ...
        if (subjectIdForApproval) {
            axiosInstance.post(`/lecturer/manageTutorial/browse/${subjectIdForApproval}`, {}, {
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                }
            })
                .then(response => {
                    console.log('Duyệt đề tài thành công:', response.data);
    ...
    const handleSubmitRefuse = () => {
        ...
        if (subjectIdForRefuse) {
            axiosInstance.post(`/lecturer/manageTutorial/refuse/${subjectIdForRefuse}`, null, {
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                },
                params: {
