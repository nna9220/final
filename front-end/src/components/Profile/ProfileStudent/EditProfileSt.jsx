...
function EditProfileSt() {
    ...
    const isValidInputFirstName = (firstName) => {
                            ...
                            <div class="row gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-left">
                                        {editingMode && (
                                            <>
                                                <button type="button" id="cancel" name="cancel" class="btn btn-secondary" onClick={handleCancel} style={{ marginRight: '10px' }}>Thoát</button>
